...
So với phương pháp Parent-Child Chunking phổ biến [2] chỉ hỗ trợ 2 cấp độ phân cấp, thuật toán đề xuất xử lý được 4 cấp (Chương – Điều – Khoản – Điểm) và gắn metadata chi tiết cho từng chunk, cho phép lọc chính xác theo số Điều hoặc Chương cụ thể.
